...
import  { getDeliveries, updateDeliveryStatus, confirmDelivery } from "../../services/api";
    ...
    <>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:16, marginBottom:24 }}>
        {[
          ...
          { label:"Total Riders",      value: deliveries.reduce((s,d)=>s+(d.rider_id?1:0),0), badge:"stable" },
