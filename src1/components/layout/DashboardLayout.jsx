      ...
      <div className="ab-main">
        <header className="ab-topbar">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            {/* Notification Bell */}
            <button className="relative bg-transparent border-none cursor-pointer p-2 rounded-lg hover:bg-gray-100 transition-colors">
              <RiNotification2Line size={20} className="text-gray-600" />
            </button>

            {/* Help/Question */}
            <button className="bg-transparent border-none cursor-pointer p-2 rounded-lg hover:bg-gray-100 transition-colors">
